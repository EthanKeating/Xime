...
public class FastInv implements InventoryHolder {
    ...
    protected XimePlugin plugin = XimePlugin.getPlugin(XimePlugin.class);
    ...
    public FastInv(int size, String title) {
        this(owner -> Bukkit.createInventory(owner, size, ChatColor.translateAlternateColorCodes('&', title)));
    }
    ...
    public FastInv(InventoryType type, String title) {
        this(owner -> Bukkit.createInventory(owner, type, ChatColor.translateAlternateColorCodes('&', title)));
    }
