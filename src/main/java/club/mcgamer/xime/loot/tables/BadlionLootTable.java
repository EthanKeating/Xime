...
public class BadlionLootTable extends LootTable {
    ...
    public final List<ItemStack> getSelectionChestItems() {
        return Arrays.asList(
                ...
                new ItemBuilder(Material.IRON_HELMET).lore(Collections.singletonList(TextUtil.translate("&9+2 Armor"))).build(),
                new ItemBuilder(Material.IRON_CHESTPLATE).lore(Collections.singletonList(TextUtil.translate("&9+6 Armor"))).build(),
                new ItemBuilder(Material.IRON_LEGGINGS).lore(Collections.singletonList(TextUtil.translate("&9+5 Armor"))).build(),
                new ItemBuilder(Material.IRON_BOOTS).lore(Collections.singletonList(TextUtil.translate("&9+2 Armor"))).build(),

                new ItemBuilder(Material.CHAINMAIL_HELMET).lore(Collections.singletonList(TextUtil.translate("&9+2 Armor"))).build(),
                new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).lore(Collections.singletonList(TextUtil.translate("&9+5 Armor"))).build(),
                new ItemBuilder(Material.CHAINMAIL_LEGGINGS).lore(Collections.singletonList(TextUtil.translate("&9+4 Armor"))).build(),
                new ItemBuilder(Material.CHAINMAIL_BOOTS).lore(Collections.singletonList(TextUtil.translate("&9+1 Armor"))).build(),

                new ItemBuilder(Material.GOLD_HELMET).lore(Collections.singletonList(TextUtil.translate("&9+2 Armor"))).build(),
                new ItemBuilder(Material.GOLD_CHESTPLATE).lore(Collections.singletonList(TextUtil.translate("&9+5 Armor"))).build(),
                new ItemBuilder(Material.GOLD_LEGGINGS).lore(Collections.singletonList(TextUtil.translate("&9+3 Armor"))).build(),
                new ItemBuilder(Material.GOLD_BOOTS).lore(Collections.singletonList(TextUtil.translate("&9+1 Armor"))).build(),
                ...
                new ItemStack(Material.BAKED_POTATO, 2),
    ...
    private final List<ItemStack> tier1Items = new ArrayList<ItemStack>(){{
        ...
        add(new ItemStack(Material.GOLD_AXE));
        ...
        add(new ItemStack(Material.PUMPKIN_PIE, 1));

        add(new ItemStack(Material.BAKED_POTATO));
        add(new ItemStack(Material.APPLE));
        add(new ItemStack(Material.COOKIE, 1));
    ...
    private final List<ItemStack> tier2Items = new ArrayList<ItemStack>(){{
        add(new ItemStack(Material.STONE_SWORD));
        add(new ItemStack(Material.IRON_AXE));

        add(new ItemStack(Material.WEB));
        add(new ItemBuilder(Material.ENDER_CHEST).name(SELECTION_CHEST_NAME).lore(Arrays.asList("&eRight click to open an inventory", "&eof T2 items. You can choose only", "&eone item that you get.")).build());
